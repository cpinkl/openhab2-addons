 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_org_openhab_binding_hideki_internal_HidekiDecoder_setTimeOut(JNIEnv*, jobject, jint);
 ...
 * Class:     org_openhab_binding_hideki_internal_HidekiDecoder
 * Method:    create
 * Signature: (Lorg/openhab/binding/hideki/internal/HidekiReceiver;I)V
 */
JNIEXPORT void JNICALL Java_org_openhab_binding_hideki_internal_HidekiDecoder_create(JNIEnv*, jobject, jint, jint);
